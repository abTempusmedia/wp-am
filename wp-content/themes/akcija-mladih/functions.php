<?php
/**
 * akcija-mladih functions and definitions
 *
...
if ( ! function_exists( 'akcija_mladih_setup' ) ) :
/**
 ...
 */
function akcija_mladih_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on akcija-mladih, use a find and replace
	 * to change 'akcija-mladih' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'akcija-mladih', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'akcija_mladih_custom_background_args', array(
...
add_action( 'after_setup_theme', 'akcija_mladih_setup' );
 ...
 */
function akcija_mladih_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'akcija_mladih_content_width', 640 );
}
add_action( 'after_setup_theme', 'akcija_mladih_content_width', 0 );
 ...
 */
function akcija_mladih_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'akcija-mladih' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'akcija-mladih' ),
...
add_action( 'widgets_init', 'akcija_mladih_widgets_init' );
